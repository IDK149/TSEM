...
pub fn fa() -> HashMap<String, String> {
    ...
    input_to_char.insert("4D".to_string(), "Q".to_string());
    input_to_char.insert("2D".to_string(), "n".to_string());
