...
pub fn sol() -> HashMap<String, String> {
    ...
    input_to_char.insert("4A".to_string(), "o".to_string());

    // Mapeos para las notas con bemol
    input_to_char.insert("1Ab".to_string(), ")?".to_string());
    input_to_char.insert("2Ab".to_string(), "c?".to_string());
    input_to_char.insert("4Ab".to_string(), "o?".to_string());
    ...
    input_to_char.insert("1B".to_string(), "_".to_string());
    ...
    input_to_char.insert("1B#".to_string(), "1bbemol".to_string());
    input_to_char.insert("2B#".to_string(), "2bsostenido".to_string());
    input_to_char.insert("4B#".to_string(), "4bsostenido".to_string());

    input_to_char.insert("1C".to_string(), "+".to_string());
    input_to_char.insert("2C".to_string(), "l".to_string());
    input_to_char.insert("4C".to_string(), "r".to_string());

    // Mapeos para las notas con bemol con "C" en lugar de "B"
    input_to_char.insert("1Cb".to_string(), "B+".to_string());
    input_to_char.insert("2Cb".to_string(), "Bl".to_string());
    input_to_char.insert("4Cb".to_string(), "Br".to_string());
    ...
    input_to_char.insert("4D".to_string(), "t".to_string());

    // Mapeos para las notas con bemol con "D" en lugar de "C"
    input_to_char.insert("1Db".to_string(), "N^".to_string());
    input_to_char.insert("2Db".to_string(), "N;".to_string());
    input_to_char.insert("4Db".to_string(), "Nt".to_string());
    ...
    input_to_char.insert("1E".to_string(), "&".to_string());
    input_to_char.insert("2E".to_string(), "'".to_string());
    input_to_char.insert("4E".to_string(), "y".to_string());

    // Mapeos para las notas con bemol con "E" en lugar de "D"
    input_to_char.insert("1Eb".to_string(), "M&".to_string());
    input_to_char.insert("2Eb".to_string(), "M'".to_string());
    input_to_char.insert("4Eb".to_string(), "My".to_string());
    ...
    input_to_char.insert("4F".to_string(), "u".to_string());

    // Mapeos para las notas con bemol con "F" en lugar de "E"
    input_to_char.insert("1Fb".to_string(), "<*".to_string());
    input_to_char.insert("2Fb".to_string(), "<z".to_string());
    input_to_char.insert("4Fb".to_string(), "<u".to_string());
    ...
    input_to_char.insert("1G".to_string(), "(".to_string());
    input_to_char.insert("2G".to_string(), "x".to_string());
    input_to_char.insert("4G".to_string(), "i".to_string());

    // Mapeos para las notas con bemol con "G" en lugar de "F"
    input_to_char.insert("1Gb".to_string(), ">(".to_string());
    input_to_char.insert("2Gb".to_string(), ">x".to_string());
    input_to_char.insert("4Gb".to_string(), ">i".to_string());
